...
namespace UCS.PacketProcessing
{
    ...
    static class CommandFactory
    {
        ...
        static CommandFactory()
        {
            ...
            m_vCommands.Add(603U, typeof(SurrenderFromBattleCommand));
           ...
           // m_vCommands.Add(511U, typeof(RequestAllianceUnitsCommand));
           // m_vCommands.Add(540U, typeof(RequestAllianceUnitsCommand));
            m_vCommands.Add(541U, typeof(SpeedUpRequestUnitsCommand));
        }
