    ...
    class Gateway
    {
        ...
        void OnClientConnect(System.IAsyncResult result)
        {
            try
            {
                ...
                Console.WriteLine("Player Joined (" + ((IPEndPoint)clientSocket.RemoteEndPoint).Address.ToString() + ":" + ((IPEndPoint)clientSocket.RemoteEndPoint).Port.ToString() + ")");
