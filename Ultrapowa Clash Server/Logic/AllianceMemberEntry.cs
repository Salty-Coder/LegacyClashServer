...
namespace UCS.Logic
{
    class AllianceMemberEntry
    {
        ...
        public byte[] Encode()
        {
            ...
            Level avatar = ResourcesManager.GetAlliance(m_vAvatarId);
       ...
       /* public void CalculateScore()
        {
            var alliance = m_vAlliance;
            var m_vAllianceScore = 0;
            ...
            m_vAllianceScore = totalScore;
            alliance.SetScore(m_vAllianceScore);
        }
*/
...
/*        public int GetScore()
        ...
        {
            Level avatar = ResourcesManager.GetAlliance(m_vAvatarId);
            ClientAvatar playerAvatar = avatar.GetPlayerAvatar();
            return playerAvatar.GetScore();
        }
    }
}
