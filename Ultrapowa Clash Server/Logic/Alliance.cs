...
/*        public void AddChatMessage(StreamEntry message)
        ...
        public void LoadFromJSON(string jsonString)
        {
            ...
            if (jarray != null)
            {
                foreach (JToken jtoken2 in jarray)
                {
                    ...
                    int num2 = jobject3["type"].ToObject<int>();
                    if (num2 != 2)
                    {
                        if (num2 == 4)
                        {
        ...
        public void SetWonWars(int wins)
        {
            m_vWonWars = wins;
        }
        public void SetLostWars(int lost)
        {
            m_vLostWars = lost;
        }
        public void SetDrawWars(int draw)
        {
            m_vDrawWars = draw;
        }
